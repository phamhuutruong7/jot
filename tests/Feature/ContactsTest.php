...
class ContactsTest extends TestCase
{
    ...
    {
        //this test to check that every 1-many relation is right.
        //Detail of each Contacts for every User.
    ...
    public function an_authenticated_user_can_add_a_contact()
    {
        ...
        $this->assertEquals('04/09/1993', $contact->birthday->format('m/d/Y'));
        $this->assertEquals('ABC String', $contact->company);

        $response->assertStatus(Response::HTTP_CREATED); //this equivalent to response code 201
        $response->assertJson([
            'data' => [
                'contact_id' => $contact->id
            ],
...
//    }
    ...
    public function birthdays_are_properly_stored()
    {
        $this->withoutExceptionHandling();
        $response = $this->post('/api/contacts',
            array_merge($this->data(), ['birthday' => 'Apr 9, 1993']));

        $this->assertCount(1, Contact::all());
        $this->assertInstanceOf(Carbon::class, Contact::first()->birthday);
        $this->assertEquals('04-09-1993', Contact::first()->birthday->format('m-d-Y'));
    }
    ...
    {
        //this test tend to have a fail result.
        //to check if when a contact is being retrieved can get the data of another user.
        $contact = factory(Contact::class)->create(['user_id' => $this->user->id]);
        $anotherUser = factory(User::class)->create();
    ...
    public function a_contact_can_be_deleted()
    {
        ...
        $this->assertCount(0, Contact::all());
        $response->assertStatus(Response::HTTP_NO_CONTENT); //equivalent 204
    }
